    ...
    function runOAuth2(engine, req) {
        ...
        if (req === null) {
            ...
            return Q.ninvoke(auth, 'getOAuthAccessToken', code, options)
                .then(([accessToken, refreshToken]) => params.callback(engine, accessToken, refreshToken))
                .catch((e) => {
    ...
    runOAuth2.install = function install(classdef) {
        Object.defineProperty(classdef, 'refreshCredentials', {
            value: function refreshCredentials() {
                ...
                return Q.ninvoke(auth, 'getOAuthAccessToken', this.state.refreshToken, options).then(([accessToken]) => {
