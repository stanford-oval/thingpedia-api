...
module.exports = new lang.Class({
    ...
    getAction: function(id, params) {
        return this.engine.channels.getOpenedChannel(this, id, 'w', params);
    },

    // Get a channel class that is identified with the given ID
    // (This is called indirectly by getChannel when a new channel
    // needs to be constructed)
    // You should override this to return your own channel classes
    getChannelClass: function(kind) {
        return this.constructor.require('./' + kind);
    },

    getTriggerClass: function(kind) {
        return this.getChannelClass(kind);
    },
