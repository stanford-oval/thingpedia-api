...
module.exports = new lang.Class({
    ...
    // it afterwards
    // do not override
    invokeTrigger: function(id, params) {
        return this.getTrigger(id, params).then(function(trigger) {
            var value = trigger.event;
            return trigger.close().then(function() { return value; });
        });
    },
